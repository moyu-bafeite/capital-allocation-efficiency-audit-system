...
class DataLayerTest(unittest.TestCase):
    ...
    def test_normalizer_handles_optional_non_cash_adjustment_fields(self):
        ...
        self.assertIn("revenue", normalized_a["financials"])
        self.assertIn("accounts_receivable", normalized_a["financials"])
        self.assertIn("inventory", normalized_a["financials"])
        self.assertIn("accounts_payable", normalized_a["financials"])
        self.assertIn("operating_income_before_wc_change", normalized_a["financials"])
        self.assertIn("cash_from_business_operations", normalized_a["financials"])
        ...
        self.assertEqual(normalized_a["financials"]["revenue"], [0.0, 0.0])
        self.assertEqual(normalized_a["financials"]["accounts_receivable"], [0.0, 0.0])
        self.assertEqual(normalized_a["financials"]["inventory"], [0.0, 0.0])
        self.assertEqual(normalized_a["financials"]["accounts_payable"], [0.0, 0.0])
        self.assertEqual(normalized_a["financials"]["operating_income_before_wc_change"], [0.0, 0.0])
        self.assertEqual(normalized_a["financials"]["cash_from_business_operations"], [0.0, 0.0])
