...
def render_selected_section(section: str, data: CompanyAuditInput, params: AuditParams, result: AuditResult) -> None:
    if data.amount_unit == "absolute" and section != SECTION_LEDGER:
        ...
        fields_to_scale = [
            ...
            "revenue", "accounts_receivable", "inventory", "accounts_payable",
            "operating_income_before_wc_change", "cash_from_business_operations",
            "working_capital", "delta_working_capital",
            "expansion_delta_wc", "maintenance_delta_wc",
